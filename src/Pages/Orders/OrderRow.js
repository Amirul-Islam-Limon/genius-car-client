...
const OrderRow = ({order, handleDelete,handleStatusUpdate}) => {
    ...
    useEffect(() => {
        fetch(`https://genious-car-server-gold.vercel.app/services/${service}`)
            .then(res => res.json())
            ...
            <div className="flex items-center space-x-3">
                <div className="avatar">
                        <div className="rounded w-24 h-24">
                            ...
                            {
                                !orderService?.img && <img src="/tailwind-css-component-profile-2@56w.png" alt="Avatar Tailwind CSS Component" />
                            }
